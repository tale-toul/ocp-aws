...
* **dns_domain_ID**.- Zone ID for the route 53 base DNS domain that will be used for this cluster
...
* **ssh-keyfile**.- Name of the file with the public part of the SSH key to transfer to the EC2 instances. The key name will be generated by appending a random string of 5 characters to the name *ssh-key-*, this way the uniqueness of the name is guarrantied.
